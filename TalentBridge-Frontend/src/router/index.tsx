...
import ResetPasswordPage from "@/pages/client/auth-page/ResetPasswordPage";
...
const router = createBrowserRouter([
      ...
      { path: "chat", element: <UserChatPage /> },
      {
        ...
        children: [
          ...
          },
          {
            path: "chat",
            element: (
              <ProtectedRoute to="/user" requiredPermission="POST /chat-message">
                <UserChatPage />
              </ProtectedRoute>
            ),
          },
  ...
  // =========================
  {
    ...
    element: (
      <ProtectedRoute
        to="/"
        requiredPermission="GET /admin/dashboard/stats"
      >
        <AdminPage />
      </ProtectedRoute>
    ),
